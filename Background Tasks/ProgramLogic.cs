    ...
    class ProgramLogic
    {
        public async Task runTask()
        {
            ...
            var exchanges = new[]
            {
                ...
                new { Name="Bitget", SpotApi="https://api.bitget.com/api/spot/v1/public/products", FuturesApi="https://api.bitget.com/api/mix/v1/market/contracts?productType=umcbl" },
